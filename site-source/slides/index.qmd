---
title: "ART FROM CODE"
author: "Danielle Navarro<br><br>Wifi: &nbsp; Username: conf22 &nbsp; Password: together!"
execute:
  echo: true
  fig-width: 6
  fig-height: 6
...
Some introductions might be a good idea, yes? :)
...
::: {layout-ncol=3}
![A spatial pattern](../img/ascii-cross.png)

![Same idea but pretty](../day-1/session-2/index_files/figure-html/random-crosses-1.png)

<br><br>What if we used fancier patterns?
...
## Example: [Smudged hexagons](https://art-from-code.netlify.app/day-1/session-3/#using-the-method-smudged-hexagons)

![](../day-1/session-3/index_files/figure-html/layered-smudged-hexagon-1.png)
